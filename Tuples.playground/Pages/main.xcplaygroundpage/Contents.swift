 ...
 */
// write your code here
print("\(person.name) is \(person.age) years old")  // John is 25 years old
/*: question3
 ...
 */
// write your code here
print("Happy \(friend.age) birthday, \(friend.name)")   // Happy 24 birthday, Sue
/*:
 ### 9. Create a _constant_ tuple called `human`, with named fields for `name` and `age`.
 */
// write your code here
let human = (name: "human", age: 0)
/*:
 ### 10. Can you change `human`'s age? Why or why not?
 */
// No, you can not modify let (constant) tuple
